...
class ReferenceClientsForm(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Справочник: Заказчики (Clients)")
    ...
    def print_data(self):
        # Имитация печати
        QMessageBox.information(self, "Печать", "Здесь могла бы быть ваша печать списка заказчиков...")
