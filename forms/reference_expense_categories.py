# forms/reference_expense_categories.py
...
class ReferenceExpenseCategoriesForm(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Справочник: Категории расходов (ExpenseCategories)")
    ...
    def print_data(self):
        QMessageBox.information(self, "Печать", "Здесь могла бы быть ваша печать списка категорий расходов...")
