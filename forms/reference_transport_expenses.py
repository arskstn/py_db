# forms/reference_transport_expenses.py
...
class ReferenceTransportExpensesForm(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Справочник: Транспортные расходы (TransportExpenses)")
    ...
    def print_data(self):
        QMessageBox.information(self, "Печать", "Здесь могла бы быть ваша печать списка транспортных расходов...")
